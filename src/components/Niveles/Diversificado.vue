<template>
  <div class="text-center">
      ...
      <v-container v-for="(item, i) in carreras" :key="i" class="mt-5">
        <v-card v-if="i % 2" elevation="1">
          <v-row style="margin: 0px; background: rgb(255, 255, 255); border-radius: 10px" no-gutters>
            <v-col
              :order="screenWidth > 600 ? 'first' : 'last'"
              cols="12"
              md="6"
              class="px-3 py-0"
            >
              <div class="outer-div">
                <div class="text-center">
                  <p class="title-carrera mt-md-3 mt-3">
                    ...
                    {{
                      item.orientacion != "" ? "Con Orientacion " + item.orientacion : ""
                    }}
                    <br />
        ...
        <v-card v-else elevation="1">
          <v-row style="background: rgb(255, 255, 255); border-radius: 10px; margin: 0px;">
            <v-col cols="12" md="6" class="px-3 py-0" :order="i % 2 ? 'last' : 'first'">
              <v-img
                max-height="570px"
                :src="item.url"
            ...
            <v-col cols="12" md="6" class="px-3 py-0">
              <div class="outer-div">
                <div class="text-center">
                  <p class="title-carrera title-center mt-md-3 mt-3">
