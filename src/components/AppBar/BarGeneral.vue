        ...
        <v-app-bar  style="background: #ffbb00 !important" dark app height="90">
            <v-toolbar-title class="mt-12" v-if="maxWidth > 700">
                <router-link to="/">
                    ...
                    <img style="width: 220px !important; height: 140px;" src="../../assets/img/logos.png" alt="logo" />
                </router-link>
            </v-toolbar-title>
            <v-spacer></v-spacer>
            <v-toolbar-title class="mt-12 " v-if="maxWidth < 700">
            ...
            <v-icon dark prominent @click.stop="drawer = !drawer" class="d-flex d-sm-none text-right"
                style="position: absolute; right: 5px; zoom: 1.5; z-index: 3">mdi-menu</v-icon>
            <v-spacer></v-spacer>

          
                <router-link class="d-none d-sm-flex link-nav ml-8" style="color: #fff; margin-left: 5px; margin-right: 15px"
                    to="/">Inicio</router-link>
                    <router-link  class="d-none d-sm-flex link-nav ml-8" style="color: #fff; margin-left: 5px; margin-right: 15px"
                    to="/niveles">Niveles</router-link>
                    <router-link  class="d-none d-sm-flex link-nav ml-8" style="color: #fff; margin-left: 5px; margin-right: 15px"
                    to="/eventos">Eventos</router-link>
                    <router-link class="d-none d-sm-flex link-nav ml-8" style="color: #fff; margin-left: 5px; margin-right: 15px"
                    to="/admisiones"> <v-btn elevation="0" color="success">Admisión</v-btn> </router-link>
